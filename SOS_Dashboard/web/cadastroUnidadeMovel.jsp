                ...
                <nav class="navbar navbar-transparent navbar-absolute">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand"> Cadastro Ambulância </a>
                        </div>
                        ...
                        <form id="formCadastro" action="controle" method="post">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane" id="sobre">
                                    <h5 class="info-text"> Por favor, informe os dados do veículo. </h5>
                                    <div class="row">                                        
                                        <div class="col-md-4">
                                        ...
                                        <div class='col-md-4'>
                                            <div class='form-group'  style='margin-top: 0px'>
                                                <label class='control-label' style='margin-top: 12px'>Tipo de Ambulância</label>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group label-floating">
                                                <label class="control-label">Nº da Unidade</label>
                                ...
                                <div class="tab-pane" id="credenciar">
                                    <h5 class="info-text"> Senha para ativar a unidade móvel no sistame. </h5>                                                                       
                                    <div class="row">
                                        <div class='col-md-4'>
                                            <div class='form-group label-floating'>
        ...
        function verificandoNomeAmbulancia() {
            ...
            $.post("AjaxControle", {logicaAjax: "AjaxValidacaoNomeAmbulancia", tipoAmbulancia: valorTipoAmbulancia, numeroAmbulancia: valorNumeroAmbulancia}, function (data, status) {
                ...
                if(objDados[0].confirmacaoNomeAmbulancia === 'false'){
                    ...
                    swal({type: 'info', title: 'Oops...', text: 'Já existe cadastro com o número: '+ valorNumeroAmbulancia +'.', showConfirmButton: false, timer: 4000});
        ...
        function verificandoPlaca() {
            ...
            $.post("AjaxControle", {logicaAjax: "AjaxValidacaoPlaca", placa: valorPlaca}, function (data, status) {
                ...
                if(objDados[0].confirmacaoPlaca === 'false'){
                    ...
                    swal({type: 'info', title: 'Oops...', text: 'Já existe cadastro com essa placa: '+ valorPlaca +'.', showConfirmButton: false, timer: 4000});
