...
<html lang="pt-br">
    ...
    <script>
        ...
        function aplicandoDados() {
            ...
            if(radiosChecked[1] === "Trânsito"){
                console.log("É NOS>>>>>> " + radiosChecked[1]);
                
                $.post("AjaxControle", {logicaAjax: "AjaxGrauDeUrgenciaTraumatico",
                                    idR: valorIdR,
                                    especificacao: radiosChecked[1],
                                    gravidadeCaso: comboboxGravidade,
                                    valorSocial: comboboxSocial,
                                    valorRecursos: comboboxRecursos,
                                    valorTempo: comboboxTempo,
                                    local: radiosChecked[2],
                                    equipamentoSeguranca: radiosChecked[3],
                                    vitimaMove: radiosChecked[4],
                                    acordado: radiosChecked[5],
                                    falando: radiosChecked[6],
                                    sangramento: radiosChecked[7],
                                    ejetadaDoVeiculo: radiosChecked[8],
                                    presaFerragens: radiosChecked[9],
                                    respiracao: radiosChecked[10],
                                    morteOcupante: radiosChecked[11]}, function (data, status) {
                                                                                          
                });
                
            }
            
            if(radiosChecked[1] === "Queda"){
                console.log("É NOS>>>>>> " + radiosChecked[1]);
                ...
                $.post("AjaxControle", {logicaAjax: "AjaxGrauDeUrgenciaTraumatico",
                                    ...
                                    valorRecursos: comboboxRecursos,
                                    valorTempo: comboboxTempo,
                                    tipoQueda: radiosChecked[2],
                                    vitimas: radiosChecked[3],
                                    vitimaMove: radiosChecked[4],
                                    acordado: radiosChecked[5],
                                    respiracao: radiosChecked[6],
                                    falando: radiosChecked[7],
                                    sangramento: radiosChecked[8]}, function (data, status) {
                                                                                          
                });
                
            }
            
            if(radiosChecked[1] === "Queimaduras"){
                console.log("É NOS>>>>>> " + radiosChecked[1]);
                ...
                $.post("AjaxControle", {logicaAjax: "AjaxGrauDeUrgenciaTraumatico",
                                    ...
                                    valorRecursos: comboboxRecursos,
                                    valorTempo: comboboxTempo,
                                    agenteCausador: radiosChecked[2],
                                    vitimas: radiosChecked[3],
                                    acordado: radiosChecked[4],
                                    falando: radiosChecked[5],
                                    respiracao: radiosChecked[6],
                                    sangramento: radiosChecked[7],
                                    atingiuFace: radiosChecked[8],
                                    aspirouFumaca: radiosChecked[9]}, function (data, status) {
                                                                                          
                });
                
            }
            
            if(radiosChecked[1] === "F.A.F/F.A.B"){
                console.log("É NOS>>>>>> " + radiosChecked[1]);
                ...
                $.post("AjaxControle", {logicaAjax: "AjaxGrauDeUrgenciaTraumatico",
                                    ...
                                    valorRecursos: comboboxRecursos,
                                    valorTempo: comboboxTempo,
                                    vitimas: radiosChecked[2],
                                    vitimaMove: radiosChecked[3],
                                    acordado: radiosChecked[4],
                                    falando: radiosChecked[5],
                                    respiracao: radiosChecked[6],
                                    ferimento: radiosChecked[7]}, function (data, status) {
                                                                                          
                });
                
            }
            
            if(radiosChecked[1] === "Desabamento/Soterramento"){
                console.log("É NOS>>>>>> " + radiosChecked[1]);
                ...
                $.post("AjaxControle", {logicaAjax: "AjaxGrauDeUrgenciaTraumatico",
                                    ...
                                    valorRecursos: comboboxRecursos,
                                    valorTempo: comboboxTempo,                                    
                                    vitimas: radiosChecked[2]}, function (data, status) {
                                                                                          
                });
                
            }
            
            if(radiosChecked[1] === "Agressões Interpessoais"){
                console.log("É NOS>>>>>> " + radiosChecked[1]);
                ...
                $.post("AjaxControle", {logicaAjax: "AjaxGrauDeUrgenciaTraumatico",
                                    ...
                                    valorRecursos: comboboxRecursos,
                                    valorTempo: comboboxTempo,
                                    houveBriga:radiosChecked[2],
                                    vitimas: radiosChecked[3],
                                    vitimaMove: radiosChecked[4],                                    
                                    acordado: radiosChecked[5],
                                    respiracao: radiosChecked[6],
                                    falando: radiosChecked[7],        
                                    sangramento: radiosChecked[8],                                    
                                    agressaoSocos: radiosChecked[9]}, function (data, status) {
                                                                                          
                });
                
            }
            
            if(radiosChecked[1] === "Outros Traumatismos"){
                console.log("É NOS>>>>>> " + radiosChecked[1]);
