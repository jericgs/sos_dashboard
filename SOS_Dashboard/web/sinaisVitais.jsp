                                    ...
                                    <div class="card-content">
                                        <form id="formRegulacao" action="controle" method="post">  
                                            ...
                                            <div class="row"> 
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group label-floating">
                                                        <label class="control-label">T. Axilar(ºC)</label>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group" style="margin-top: 0px">
                                                        ...
                                                        <select id="combobox" name="gravidadeComprovada" class="form-control selectpicker" data-style="select-with-transition" title="Nenhum" data-size="4">                                                                                                                        
