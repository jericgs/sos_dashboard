...
*/
/* 
    Created on : 06/06/2018, 10:19:24
    Author     : jerick.gs
*/
/*================================================================================*/
...
.off-canvas-sidebar .logo .simple-text {
    text-transform: uppercase;    
    display: block;
    font-size: 15px; //TAMANHO FONTE AO LADO DO LOGO
    color: #3C4858;
    text-align: left;
    font-weight: 400;
    line-height: 70px;
...
.sidebar .logo-tim img,
.off-canvas-sidebar .logo-tim img { //TAMANHO IMAGEM LOGO
    width: 80px;
    height: 80px;
}
...
.form-group .form-control {
    ...
    /*background-image: linear-gradient(#b71c1c, #b71c1c), linear-gradient(#D2D2D2, #D2D2D2 1px,transparent 0);*/    
    /*background-image:linear-gradient(0deg,#b71c1c 2px,rgba(156,39,176,0) 0),linear-gradient(0deg,rgba(0,0,0,.26) 1px,transparent 0);*/
    /*background-image:linear-gradient(0deg,#b71c1c 2px,rgba(156,39,176,0) 0),linear-gradient(0deg,rgba(0,0,0,.26) 1px,transparent 0);*/
...
.alert.alert-danger {
    ...
    color: #ffffff;
    border-radius: 3px;
    box-shadow: 0 12px 20px -10px rgba(182, 27, 27, 0.28), 0 4px 20px 0px rgba(0, 0, 0, 0.12), 0 7px 8px -5px rgba(182, 27, 27, 0.2);
}
...
//REMOVE CONTORNO ENTRE DROP CADASTRO
...
.card [data-background-color="red"] {
    background: linear-gradient(60deg, #b71c1c, #e53935);
    box-shadow: 0 12px 20px -10px rgba(244, 67, 54, 0.28), 0 4px 20px 0px rgba(0, 0, 0, 0.12), 0 7px 8px -5px rgba(244, 67, 54, 0.2);
}
...
.bootstrap-select.btn-group .dropdown-menu.inner{
    ...
    padding:5px 0;
    margin:0;
    box-shadow:none;-ms-overflow-style:auto
